...
//xModel: ls_vehicle_civilian_sedan_red_dusty_iw6
requires maya "8.5";
...
createNode transform -n "Tom_ls_vehicle_civilian_sedan_red_dusty_iw6";
setAttr ".ove" yes;
createNode transform -n "TomMeshjAuc6E_0" -p "Tom_ls_vehicle_civilian_sedan_red_dusty_iw6";
setAttr ".rp" -type "double3" 0.000000 0.000000 0.000000 ;
setAttr ".sp" -type "double3" 0.000000 0.000000 0.000000 ;
createNode mesh -n "MeshShape_0" -p "TomMeshjAuc6E_0";
setAttr -k off ".v";
