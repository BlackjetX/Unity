...
//xModel: vehicle_18wheeler_ygb_destroyed
requires maya "8.5";
...
createNode transform -n "Tom_vehicle_18wheeler_ygb_destroyed";
setAttr ".ove" yes;
createNode transform -n "TomMeshjAuc6E_0" -p "Tom_vehicle_18wheeler_ygb_destroyed";
