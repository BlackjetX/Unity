...
//xModel: vehicle_berlin_coupe_blue_destroyed
requires maya "8.5";
...
createNode transform -n "Tom_vehicle_berlin_coupe_blue_destroyed";
setAttr ".ove" yes;
createNode transform -n "TomMeshn1ahBQ_0" -p "Tom_vehicle_berlin_coupe_blue_destroyed";
